...
1. **Define the Tiers:** Distinguish between the Total Addressable Market (TAM), Serviceable Available Market (SAM), and Serviceable Obtainable Market (SOM).
...
3. **Execute the TAM Calculation:** Walk through the five-step math process (Universe -> Interest -> Conversion -> Price -> Result).
...
### 4. Alternative Math (Drake Equation)
For visibility of assumptions, use:
**TAM = N * price**
