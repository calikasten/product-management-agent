...
Instructions and prompts for using LLMs as an autonomous partner in product management work. Last Updated 01/28/2026. 
...
```shell
 curl -s 'https://raw.githubusercontent.com/calikasten/product-management-agent/main/Agents/Effective%20Writer.md' > './effective-writer.mdc'
```
...
```shell
 curl -s 'https://raw.githubusercontent.com/calikasten/product-management-agent/main/Skills/Create%20PRD.md' > './SKILL.md'  
```
